...
public class ONithBit {
    ...
    /*
     * Write a program to input a number to switch ON the ith bit in it's binary equivalent
     ...
     * if n = 36 and i = 3
     * then,
     * we'll create a mask using 1 and shift left with the position of i (i.e 3)
     * and do OR opertion with n.
     * Automatically by doing this our ith bit will switch ON. 
     */

    static void switchOn(int n, int i){
